...
//----------------------------------------------------------------------------//
CartesianMesh::CartesianMesh(size_t  dim,
                             vec_int xfm,
                             vec_int yfm,
                             vec_int zfm,
                             vec_dbl xcme,
...
//----------------------------------------------------------------------------//
void CartesianMesh::add_coarse_mesh_map(const std::string &map_key,
                                        const vec_int     &m_map)
{
  // Temporary map.
...
void CartesianMesh::setup()
{
  ...
  set_number_cells(d_number_cells_x * d_number_cells_y * d_number_cells_z);
...
//----------------------------------------------------------------------------//
void CartesianMesh::display() const
{
  using std::cout;
  using std::endl;
  cout << endl << "Detran Cartesian Mesh" << endl;
